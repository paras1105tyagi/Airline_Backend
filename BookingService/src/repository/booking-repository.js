...
class BookingRepository {
    ...
    async update(bookingId,data){
        ...
        throw new AppError('RepositoryError','Cannot update Booking','There was some issue update the booking, please try again later',StatusCodes.INTERNAL_SERVER_ERROR);
      }
